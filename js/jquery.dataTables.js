...
(function($, window, document) {
	...
	_oExt.oSort = {
		...
		// custom sort functions - src: http://stackoverflow.com/questions/3725321/jquery-datatables-change-order-to-desc-when-it-sorts
		"text-blankslast-asc" : function (x, y) {  
			var x = (x == "") ? String.fromCharCode(255) : x;  
			var y = (y == "") ? String.fromCharCode(255) : y;  
			return ((x < y) ? -1 : ((x > y) ? 1 : 0));  
		},  

		"text-blankslast-desc" : function (x, y) {  
		   var x = (x == "") ? String.fromCharCode(0) : x;  
		   var y = (y == "") ? String.fromCharCode(0) : y;  
		   return ((x < y) ? 1 : ((x > y) ? -1 : 0));  
		} 
